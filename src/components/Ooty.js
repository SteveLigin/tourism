...
function Ooty() {
  return (
    <section id="ooty" style={{marginTop:'100px'}}>
   ...
   <div className="row">
        ...
        <div className="col-sm">
           <div className='mt-2'>
               ...
               <p className='mt-3 p' style={{textIndent:'80px' , textAlign:'justify'}} >
...
Queen of the hills is a picturesque getaway.
               ...
               <p className='p'style={{textIndent:'80px' , textAlign:'justify'}} >
...
architecture, Ooty is the perfect respite everyone.
               ...
               <div class="indent"><div className='mt-5 mb-5 text-center'>
      ...
      <div className="row mb-3 ">
        ...
        <Card style={{ width: '250px', height:'400px',lineHeight:'35px' }}>
